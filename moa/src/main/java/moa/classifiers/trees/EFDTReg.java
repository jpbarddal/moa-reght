...
public class EFDTReg extends VFDT{
    ...
    public interface EFDTNode {
        ...
        public void learnFromInstance(Instance inst, EFDTReg ht, EFDTSplitNode parent, int parentBranch);
    ...
    public class EFDTSplitNode extends SplitNode implements EFDTNode{
        ...
        public EFDTSplitNode(InstanceConditionalTest splitTest,
                             int indicesFeaturesSelected[],
                             double meritsFeaturesSelected[],
                             double[] classObservations,
                             int size) {
            super(splitTest, indicesFeaturesSelected, meritsFeaturesSelected, classObservations, size);
        }
        ...
        public EFDTSplitNode(InstanceConditionalTest splitTest,
                             ...
                             double meritsFeaturesSelected[],
                             double[] classObservations) {
            super(splitTest, indicesFeaturesSelected, meritsFeaturesSelected, classObservations);
        }
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, EFDTReg ht) {
        ...
        protected void reEvaluateBestSplit(EFDTSplitNode node, EFDTSplitNode parent,
            ...
            SplitCriterion splitCriterion = (SplitCriterion) getPreparedClassOption(EFDTReg.this.splitCriterionOption);
            double hoeffdingBound = computeHoeffdingBound(splitCriterion.getRangeOfMerit(node.getClassDistributionAtTimeOfCreation()),
                    EFDTReg.this.splitConfidenceOption.getValue(), node.observedClassDistribution.sumOfValues());

            // get best split suggestions
            AttributeSplitSuggestion[] bestSplitSuggestions = node.getBestSplitSuggestions(splitCriterion, EFDTReg.this);
            ...
            double tieThreshold = EFDTReg.this.tieThresholdOption.getValue();
            ...
            if (deltaG > hoeffdingBound
                ...
                if(splitDecision.splitTest == null){
                    ...
                    node.killSubtree(EFDTReg.this);
                    EFDTLearningNode replacement = (EFDTLearningNode) newLearningNode(lambdaOption.getValue());
                    ...
                    SplitNode newSplit = newSplitNode(splitDecision.splitTest,
                            indicesSelected, meritsSelected,
                    ...
                    if (node.splitTest == splitDecision.splitTest
                        ...
                        this.killSubtree(EFDTReg.this);

                        for (int i = 0; i < splitDecision.numSplits(); i++) {

                            double[] j = splitDecision.resultingClassDistributionFromSplit(i);

                            Node newChild = newLearningNode(splitDecision.resultingClassDistributionFromSplit(i), lambdaOption.getValue());
                        ...
                        EFDTReg.this.activeLeafNodeCount--;
                        EFDTReg.this.decisionNodeCount++;
                        EFDTReg.this.activeLeafNodeCount += splitDecision.numSplits();
                    ...
                    if (parent == null) {
                        ...
                        EFDTReg.this.treeRoot = newSplit;
                    } else {
    ...
    protected void attemptToSplit(ActiveLearningNode node, SplitNode parent,
        ...
        if (!node.observedClassDistributionIsPure()) {
            ...
            if (bestSplitSuggestions.length < 2) {
                ...
                else if ((bestSuggestionAverageMerit > minValueForSplit &&
                        (bestSuggestionAverageMerit-currentAverageMerit)  > hoeffdingBound) ||
    ...
    public class EFDTLearningNode extends LearningNodeNBAdaptive implements EFDTNode{
        ...
        public EFDTLearningNode(double[] initialClassObservations, double lambda) {
    ...
    public void trainOnInstanceImpl(Instance inst) {
        ...
        if (this.treeRoot == null) {
            this.treeRoot = newLearningNode(lambdaOption.getValue());
        ...
        if (leafNode == null) {
            leafNode = newLearningNode(lambdaOption.getValue());
    ...
    protected LearningNode newLearningNode(double lambda) {
        return new EFDTLearningNode(new double[0], lambda);
    }

    protected LearningNode newLearningNode(double[] initialClassObservations, double lambda) {
        return new EFDTLearningNode(initialClassObservations, lambda);
    }
    ...
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
        ...
        return new EFDTSplitNode(splitTest, indicesFeaturesSelected, meritsFeaturesSelected, classObservations, size);
    }
    ...
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
                                     ...
                                     double meritsFeaturesSelected[],
                                     double[] classObservations) {
        return new EFDTSplitNode(splitTest, indicesFeaturesSelected, meritsFeaturesSelected, classObservations);
    }

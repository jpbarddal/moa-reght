...
public class EFDT extends VFDT{
    ...
    public class EFDTSplitNode extends SplitNode implements EFDTNode{
        ...
        public EFDTSplitNode(InstanceConditionalTest splitTest,
                             int[] indicesSelected,
                             double[] meritsSelected,
                             double[] classObservations, int size) {
            super(splitTest, indicesSelected, meritsSelected, classObservations, size);
        }
        ...
        public EFDTSplitNode(InstanceConditionalTest splitTest,
            ...
            super(splitTest, indicesSelected, meritsSelected,  classObservations);
        }
    ...
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
                                     ...
                                     double[] classObservations,
                                     int size) {
        return new EFDTSplitNode(splitTest, indicesSelected, meritsSelected, classObservations, size);
    }
    ...
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
                                     ...
                                     double[] meritsSelected,
                                     double[] classObservations) {
        return new EFDTSplitNode(splitTest, indicesSelected, meritsSelected, classObservations);
    }
